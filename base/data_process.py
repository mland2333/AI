...
data_csv_path = r'C:\Users\28929\Desktop\data.csv'
#shell_map = {}
...
'''for file in files:
    ...
    if str(index) in result_map and worksheet.cell_value(29,0) == "制壳参数记录表":
        data = [worksheet.cell_value(32,4),worksheet.cell_value(32,6),worksheet.cell_value(32,8),worksheet.cell_value(32,10),
                ...
                worksheet.cell_value(41,4),worksheet.cell_value(41,6),worksheet.cell_value(41,8),worksheet.cell_value(41,10)]
        print(i,index,data)
        shell_map[index] = data
    i+=1'''
i = 1
for file in files:
    ...
    worksheet = workbook.sheet_by_index(0)
    index = worksheet.cell_value(3,1)
    if str(index) in result_map and worksheet.nrows>=54:
        #result_hex = int(result_map[index][2]) + int(result_map[index][1])*2+int(result_map[index][0])*4
        if(str(worksheet.cell_value(46,0)) != '产品序号'):
            data = [worksheet.cell_value(12,2),worksheet.cell_value(12,4),worksheet.cell_value(12,6),worksheet.cell_value(12,8),
                    worksheet.cell_value(48,4),worksheet.cell_value(48,6),worksheet.cell_value(54,2),worksheet.cell_value(54,4),
                    worksheet.cell_value(54,8),worksheet.cell_value(54,10),
                    worksheet.cell_value(54,12)]  + result_map[index]
        else:
            data = [worksheet.cell_value(12,2),worksheet.cell_value(12,4),worksheet.cell_value(12,6),worksheet.cell_value(12,8),
                    worksheet.cell_value(47,4),worksheet.cell_value(47,6),worksheet.cell_value(53,2),worksheet.cell_value(53,4),
                    worksheet.cell_value(53,8),worksheet.cell_value(53,10),
                    worksheet.cell_value(53,12)]  + result_map[index]
            print(i,index,data)
